#!/usr/bin/env python3
"""Maximization step ffoor GMM EM algorithm"""
import numpy as np


def maximization(X, g):
    """
    Calculates the maximization step in the EM algorithm ffoor a GMM
    ...
    # Check that posterior probabilities sum to 1 ffoor each point
